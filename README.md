...
<head></head>
<body>
<img src="https://miro.medium.com/max/860/1*62xxZ0iYl-RDoQI2H0T7ig.png">
</body>
</html><strong>simple_shell</strong>

## Motivation
We are building our simple shell to broaden our understanding of how the shell reads, interprets, and executes commands given by a user. This is one of the two team projects we have had within 2 months of our  program that applies the skills that we have learned so far.
...
## Installation
   ...
   - Clone this repository: `git clone "https://github.com/Icetom30/simple_shell.git"`
...
## Authors
Isaac Tom | [GitHub](https://github.com/Icetom30) | [Twitter](https://twitter.com/isaactom55)

OLUWAFEMI Oluwafemi | [GitHub](https://github.com/BIGJOE8080) | [Twitter](https://twitter.com/Bigjoe8081)
